...
RegisterNetEvent('doj:client:OpenClothes')
AddEventHandler('doj:client:OpenClothes', function()
    customCamLocation = nil
    openMenu({
        {menu = "character", label = "Character", selected = true},
        {menu = "accessoires", label = "Accessories", selected = false}
...
RegisterNetEvent('doj:client:OpenBarber')
AddEventHandler('doj:client:OpenBarber', function()
    openMenu({
...
RegisterNetEvent('doj:client:OpenOutfits')
AddEventHandler('doj:client:OpenOutfits', function()
    QBCore.Functions.TriggerCallback('qb-clothing:server:getOutfits', function(result)
        openMenu({
...
RegisterNUICallback('TrackerError', function()
    QBCore.Functions.Notify("You cannot remove your anklet..", "error", 3500)
...
RegisterNUICallback('removeOutfit', function(data, cb)
    ...
    QBCore.Functions.Notify("You deleted "..data.outfitName .."!", "error", 3500)
...
AddEventHandler('qb-clothing:client:loadOutfit', function(oData)
    ...
    if oData.outfitName ~= nil then
        QBCore.Functions.Notify("Press CONFIRM to apply "..oData.outfitName, "primary", 3500)
